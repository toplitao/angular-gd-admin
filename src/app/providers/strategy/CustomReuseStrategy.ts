...
import { ActivatedRouteSnapshot, RouteReuseStrategy, DetachedRouteHandle,Router } from '@angular/router';
...
export class CustomReuseStrategy implements RouteReuseStrategy {
 ...
 //   constructor(private router:Router){
      //  this.router.events.distinctUntilChanged
   ...
   // }
    ...
    //    console.log("detaching", route, "return: ", detach);
        ...
        console.log("c",route.parent.children)
        return detach;
    }
    ...
    //    console.log("store:", storedRoute, "into: ", this.storedRoutes);
        ...
        // if(route.routeConfig.path!='login'){//除了login，其他都store && 跳转到login则storedRoutes要清空
